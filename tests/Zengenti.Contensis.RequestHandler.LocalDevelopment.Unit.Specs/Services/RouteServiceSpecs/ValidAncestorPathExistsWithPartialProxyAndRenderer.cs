...
public class ValidAncestorPathExistsWithPartialProxyAndRenderer
{
    ...
    public void AndThenTheCorrectRouteInfoIsReturned()
    {
        ...
        Assert.That(
            ...
            Is.EqualTo($"http://localhost:3000/blogs/keeping-it-real?nodeId={_node.Id}"));

        var expectedRoutePrefix =
            $"{Constants.Paths.StaticPathUniquePrefix}{RouteInfo.GetUrlFriendlyHash(null)}{Constants.Paths.StaticPathUniquePrefix}";
